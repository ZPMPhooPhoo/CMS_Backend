...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $users_list = Permission::create(['name' => 'userList']);
        $users_create = Permission::create(['name' => 'userCreate']);
        $users_edit = Permission::create(['name' => 'userEdit']);
        ...
        $developer->givePermissionTo([$dashboard,  $widget, $category_list, $category_create, $category_edit, $category_delete, $contract_create, $contract_edit, $quotation,$quotation_create, $quotation_edit, $client_lists, $client_project_lists, $projects, $project_edit, $project_detail, $add_client_project, $services, $client_create, $client_edit, $client_delete]);
